  ...
  fetchRestaurantFromURL((error, restaurant) => {
    if (error) { // Got an error!
      ...
      L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
        mapboxToken: 'pk.eyJ1IjoiaWFtYm9ibyIsImEiOiJjanIzaWljMDMwYnNlM3lyMmwyMmE1ZmF4In0.TtcTKyJaKnd3PRb9797ItA',
        maxZoom: 18,
...
fillRestaurantHTML = (restaurant = self.restaurant) => {
  ...
  image.setAttribute("srcset", DBHelper.imageUrlForRestaurant(restaurant) + " 800w," + DBHelper.imageUrlForRestaurantSmall(restaurant) + " 400w"); 
...
createReviewHTML = (review) => {
  ...
  li.appendChild(hdrDiv);

  const ratingHolder = document.createElement('p');
